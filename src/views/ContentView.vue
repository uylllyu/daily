  ...
  <div class="carousel">
    <div v-if="dataContent">
      ...
      <div class="carousel-bottom">
        ...
        <div @click="thumbsShow=!thumbsShow" :class="{'thumbs-up':thumbsShow}">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="icon"
            width="16px"
          ...
          <span>{{thumbsShow?extra.popularity+1:extra.popularity }}</span>
        </div>
        <div @click="favoritesShow=!favoritesShow" :class="{'thumbs-up':favoritesShow}">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="icon"
            width="16px"
          ...
          <span>{{favoritesShow?collection+1:collection}}</span>
        </div>
        <div class="svgpic">
          <svg
            xmlns="http://www.w3.org/2000/svg"
